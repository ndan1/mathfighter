...
export default class MathFighterScene extends Phaser.Scene
{
    ...
    create()
    {
        ...
        let start_button = this.add.image(this.gameHalfWidth,this.gameHalfHeight + 181,'start-btn').setInteractive().setDepth(1)
    ...
    gameStart()
    {
        ...
        this.resultText = this.add.text(this.gameHalfWidth,200,'0', {fontSize:'32px', fill:'#000', fontFamily:'Times, Times New Roman, serif'})
        
        this.questionText = this.add.text(this.gameHalfWidth, 160, '0',{fontSize: '32px', fill:'#000', fontFamily:'Times, Times New Roman, serif'})
        this.createButton()
    ...
    update(time)
    {
        ...
        if(this.correctAnswer == false && !this.enemyAttack)
        {
            ...
            this.time.delayedCall(500, () => {
                this.createSlash(this.enemy.x - 60, this.enemy.y, 0, -400)
            })
