...
init(){
    ...
    this.buttoun1   =undefined
    this.buttoun2   =undefined
    this.buttoun3   =undefined
    this.buttoun4   =undefined
    this.buttoun5   =undefined
    this.buttoun6   =undefined
    this.buttoun7   =undefined
    this.buttoun8   =undefined
    this.buttoun9   =undefined
    this.buttoun0   =undefined
    this.buttounDel =undefined
    this.buttounOk  =undefined
    this.numberArray = []
    this.number = 0
    this.question = []
    this.correctAnswer
...
createAnimation(){
    ...
    gameStart(){
        ...
        this.player.anims.play('enemy-stanby',true)
        this.resultText = this.add.text(this.gameHalfWidth,200,
            '0', { fontSize : '32px', color: '#000'})
    ...
    createButtons(){
        ...
        this.button1 = this.add.image(this.button2.x - widthDiff,startPosY,
            ...
            this.button4 = this.add.image(this.button5.x - widthDiff,this.button1.y
            + heightDiff,'numbers',3).setInteractive().setData('value', 4)

            this.button7 = this.add.image(this.button8.x - widthDiff,this.button4.y
            + heightDiff, 'numbers', 6).setInteractive().setData('value', 7)

            this.buttonDel = this.add.image(this.button0.x - widthDiff, this.button7.y
            + heightDiff, 'numbers', 9).setInteractive().setData('value','del')
         //dev
            this.button3 = this.add.image(this.button2.x + widthDiff,startPosY,
                'numbers', 2).setInteractive().setData('value', 3)

                this.button6 = this.add.image(this.button5.x + widthDiff,this.button3.y
                + heightDiff,'numbers',5).setInteractive().setData('value', 6)
    
                this.button9 = this.add.image(this.button8.x + widthDiff,this.button6.y
                + heightDiff, 'numbers', 8).setInteractive().setData('value', 9)
    
                this.buttonOk = this.add.image(this.button0.x + widthDiff, this.button9.y
                + heightDiff, 'numbers', 11).setInteractive().setData('value','ok')
        }
