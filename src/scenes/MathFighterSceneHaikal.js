...
preload(){
    ...
    this.load.spritesheet('slash','images/slash.png',{frameWidth:42,frameHeight:88}) // ini sebelumnya kebalik
...
create(){
    ...
    this.enemy = this.physics.add.sprite (
        ...
        .setBounce(0.2)
        .setOffset(20, -10) // awalnya -20, diubah jadi 20 saja
        .setFlipX(true)
    ...
    // create slash tidak ada, maka slashnya tidak akan muncul
...
.setVisible(true)
.setFrame(frame)
.setVelocityX(velocity) // kurang setVelocityX
.setFlipX(flip)
}
