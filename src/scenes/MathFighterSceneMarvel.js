...
export default class MatheFighterScene extends Phaser.Scene
{
    ...
    init()
    {
        ...
        this.gameHalfHeight = this.scale.width * 0.5
    ...
    create()
    {
        ...
        let start_button = this.add.image(this.gameHalfWidth, this.gameHalfHeight + 261, 'start-btn').setInteractive() 
    ...
    gameStart()
    {
        ...
        this.questionText = this.add.text(this.gameHalfHeight,100, '0', { fontSize : '32px', fill: '#000'})
