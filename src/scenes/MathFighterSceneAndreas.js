...
Phaser.Scene
{
    ...
    gameStart()
    {
        ...
        this.resultText = this.add.text(this.gameHalfWidth, 200, '0', {fontSize : '32px', 
    fill: '#000'})
...
generateQuestion()
{
    ...
    if (operator === '-'){
        ...
        const textHalfWdith = this.questionText.width * 0.5 
        this.questionText.setX(this.gameHalfWidth - textHalfWdith)
       }
checkAnswer()
       {
